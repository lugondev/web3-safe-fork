...
const CONFIG_SERVICE_CHAINS: ChainInfo[] = [
  ...
  },
  {
    ...
    l2: true,
    description: '',
    rpcUri: { authentication: RPC_AUTHENTICATION.NO_AUTHENTICATION, value: 'https://rpc.ankr.com/bsc_testnet_chapel' },
    safeAppsRpcUri: {
      authentication: RPC_AUTHENTICATION.NO_AUTHENTICATION,
    ...
    blockExplorerUriTemplate: {
      ...
      txHash: 'https://testnet.bscscan.com/tx/{{txHash}}',
      api: 'https://api.testnet.bscscan.com/api?module={{module}}&action={{action}}&address={{address}}&apiKey={{apiKey}}',
    },
    nativeCurrency: {
      name: 'BNBT',
      symbol: 'BNBT',
